...
public extension UIDevice {
    ...
    private func CPUinfo() -> Dictionary<String, String> {
        ...
        case "iPhone14,2", "iPhone14,3":                return ["A15 Bionic":"Hexa-core (2x3.23 GHz Avalanche + 4x1.82 GHz Blizzard)"]
        case "iPhone13,4", "iPhone13,3", "iPhone13,2":  return ["A14 Bionic":"Hexa-core, 3100 MHz, 64-bit"]
